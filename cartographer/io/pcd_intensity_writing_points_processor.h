...
class PcdIntensityWritingPointsProcessor : public PointsProcessor {
 public:
  ...
  ~PcdIntensityWritingPointsProcessor() override {}

  PcdIntensityWritingPointsProcessor(const PcdIntensityWritingPointsProcessor&) = delete;
  PcdIntensityWritingPointsProcessor& operator=(const PcdIntensityWritingPointsProcessor&) =
      delete;
