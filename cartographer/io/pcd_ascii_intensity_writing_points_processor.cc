...
void WriteBinaryPcdIntensityHeader(
  ...
  stream << "# generated by Cartographer\n"
         ...
         << "SIZE 4 4 4"    << color_header_size  << classification_header_size << intensity_header_size  << reflectivity_header_size  << ambient_header_size  << range_header_size  << ring_header_size  << " 4" << "\n"
         << "TYPE F F F"    << color_header_type  << classification_header_type << intensity_header_type  << reflectivity_header_type  << ambient_header_type  << range_header_type  << ring_header_type  << " F"  << "\n"
